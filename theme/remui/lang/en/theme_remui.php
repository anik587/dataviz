...
$string['logoorsitenamedesc'] = 'You can change the site header logo as per your choice. <br />The options available are: Logo - Only the logo will be shown; <br /> Icon+sitename - An icon along with the sitename will be shown. <br/> Site name with logo - Site name and logo will displayed(Header layout top icon bottom menu only)';
...
$string['enrolment_layout_desc'] = 'Enable New Layout Design for Enrolment Page';
$string['disable'] = 'Disable';
$string['enable_layout1'] = 'Enable Layout 1';

$string['webpage'] = "Web Page";
$string['categorypagelayout'] = 'Category Page Layout';
$string['categorypagelayoutdesc'] = 'Course Archive Page Design Selection';
...
$string['reset-settings-description'] = 'Customizer settings will be restored to default. All settings from fresh installation will be choosen as default. Do you want to continue?';
...
$string['body'] = 'Body';
$string['body-font-family_desc'] = 'Set font family for entire site.';
