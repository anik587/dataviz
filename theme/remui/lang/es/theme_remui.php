...
$string['enrolment_layout_desc'] = 'Habilitar nuevo diseño de diseño para la página de inscripción';
$string['disable'] = 'Inhabilitar';
$string['enable_layout1'] = 'Habilitar diseño 1';

$string['webpage'] = "Página web";
$string['categorypagelayout'] = 'Diseño de página de categoría';
$string['categorypagelayoutdesc'] = 'Selección del diseño de la página del archivo del curso';
...
$string['reset-settings-description'] = 'La configuración del personalizador se restaurará a la predeterminada. Todas las configuraciones de una instalación nueva se elegirán por defecto. ¿Quieres continuar?';
...
$string['body'] = 'Cuerpo';
$string['body-font-family_desc'] = 'Configure la familia de fuentes para todo el sitio.';
