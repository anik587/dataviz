...
$string['enrolment_layout_desc'] = 'Activer la nouvelle conception de mise en page pour la page d\'inscription';
$string['disable'] = 'Désactiver';
$string['enable_layout1'] = 'Activer la disposition 1';

$string['webpage'] = "Web Page";
$string['categorypagelayout'] = 'Disposition de la page de catégorie';
$string['categorypagelayoutdesc'] = 'Sélection de conception de page d\'archive de cours';
...
$string['reset-settings-description'] = 'Les paramètres de personnalisation seront restaurés par défaut. Tous les paramètres de la nouvelle installation seront choisis par défaut. Voulez-vous continuer?';
...
$string['body'] = 'Corps';
$string['body-font-family_desc'] = 'Définissez la famille de polices pour l\'ensemble du site.';
