...
$string['isedublock'] = 'Enable Edublock Submission';
$string['edublocksetting'] = 'Edublock Setting';
$string['eduhelp'] = 'EduBlock Help';
$string['eduhints'] = 'EduBlock Hints';
$string['edusolution'] = 'EduBlock Solution';
$string['edublocktab'] = 'EduBlock Tabs';
$string['eduinstruction'] = 'EduBlock Instruction';
$string['edublocktab_help'] = '1 =>Import 2=> Variable';
