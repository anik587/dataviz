...
class mod_assign_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $name = get_string('isedublock', 'assign');
        $mform->addElement('checkbox', 'isedublock', $name);
        ...
        $mform->addElement('header', 'edublock', get_string('edublocksetting', 'assign'));
        

         // Adding the standard "instruction" field.
        $mform->addElement('textarea', 'instruction', get_string('eduinstruction', 'assign'), array('cols' => '110','rows' => '8'));


         // Adding the standard "help" field.
        $mform->addElement('textarea', 'help', get_string('eduhelp', 'assign'), array('cols' => '110','rows' => '8'));

    
         // Adding the standard "help" field.
        $mform->addElement('textarea', 'hints', get_string('eduhints', 'assign'), array('cols' => '110', 'rows' => '8'));

        
         // Adding the standard "help" field.
        $mform->addElement('textarea', 'solution', get_string('edusolution', 'assign'), array('cols' => '110', 'rows' => '8'));
        ...
        $mform->addElement('select', 'block_library', get_string('edublocktab', 'assign'), $blockArray);
        $mform->getElement('block_library')->setMultiple(true);
        // This will select the skills A and B.
        //$mform->getElement('block_library')->setSelected(array('val1', 'val2'));
        //$mform->addElement('text', 'block_library', get_string('edublocktab', 'assign'), array('size' => '64'));
