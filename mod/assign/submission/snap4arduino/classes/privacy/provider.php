...
namespace assignsubmission_snap4arduino\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        $detail = [
                    ...
                    'snap4arduino_xmlproject' => 'privacy:metadata:textpurpose'
                  ];
        $collection->add_database_table('assignsubmission_snap_s4a', $detail, 'privacy:metadata:tablepurpose');
        return $collection;
    }
    ...
    public static function export_submission_user_data(assign_plugin_request_data $exportdata) {
        ...
        $plugin = $assign->get_plugin_by_type('assignsubmission', 'snap4arduino');
        $submission = $exportdata->get_pluginobject();
        $editortext = $plugin->get_editor_text('snap4arduino', $submission->id);
        if (!empty($editortext)) {
            $submissiontext = new \stdClass();
            $currentpath = $exportdata->get_subcontext();
            $currentpath[] = get_string('privacy:path', 'assignsubmission_snap4arduino');
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $DB->delete_records('assignsubmission_snap_s4a', ['assignment' => $requestdata->get_assignid()]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        // Delete the records in the table.
        $DB->delete_records('assignsubmission_snap_s4a', ['assignment' => $deletedata->get_assignid(),
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $DB->delete_records_select('assignsubmission_snap_s4a', "assignment = :assignid AND submission $sql", $params);
    }
}
