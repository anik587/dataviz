 ...
 *
 * @module     assignsubmission_snap4arduino/snap
...
export const start = (xmlproject, userid, attempt, editable) => {
    ...
    var pluginButton = document.getElementById('snapButton_snap4arduino-' + userid + '-' + attempt),
        pluginPlay = document.getElementById('play_snap4arduino-' + userid + '-' + attempt),
        newOnClick = "require(['assignsubmission_snap4arduino/view'], function(View) {View.toogleFullScreen('" +
            userid + "', '" +
...
const enterFS = (userid, attempt) => {
    var cont = document.getElementById('snapContainer_snap4arduino-' + userid + '-' + attempt),
        toggler = document.getElementById('togglingFSicon_snap4arduino-' + userid + '-' + attempt),
        iframe = document.getElementById('snap_snap4arduino-' + userid + '-' + attempt),
        navBar = document.getElementById('snapNavBar_snap4arduino-' + userid + '-' + attempt);
...
const exitFS = (userid, attempt) => {
    var toggler = document.getElementById('togglingFSicon_snap4arduino-' + userid + '-' + attempt),
        iframe = document.getElementById('snap_snap4arduino-' + userid + '-' + attempt),
        navBar = document.getElementById('snapNavBar_snap4arduino-' + userid + '-' + attempt);
