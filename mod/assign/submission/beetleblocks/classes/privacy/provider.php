...
namespace assignsubmission_beetleblocks\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        $detail = [
                    ...
                    'beetleblocks_xmlproject' => 'privacy:metadata:textpurpose'
                  ];
        $collection->add_database_table('assignsubmission_snap_bb', $detail, 'privacy:metadata:tablepurpose');
        return $collection;
    }
    ...
    public static function export_submission_user_data(assign_plugin_request_data $exportdata) {
        ...
        $plugin = $assign->get_plugin_by_type('assignsubmission', 'beetleblocks');
        $submission = $exportdata->get_pluginobject();
        $editortext = $plugin->get_editor_text('beetleblocks', $submission->id);
        if (!empty($editortext)) {
            $submissiontext = new \stdClass();
            $currentpath = $exportdata->get_subcontext();
            $currentpath[] = get_string('privacy:path', 'assignsubmission_beetleblocks');
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $DB->delete_records('assignsubmission_snap_bb', ['assignment' => $requestdata->get_assignid()]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        // Delete the records in the table.
        $DB->delete_records('assignsubmission_snap_bb', ['assignment' => $deletedata->get_assignid(),
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $DB->delete_records_select('assignsubmission_snap_bb', "assignment = :assignid AND submission $sql", $params);
    }
}
