 ...
 *
 * @module     assignsubmission_beetleblocks/snap
...
export const start = (xmlproject, userid, attempt, editable) => {
    ...
    var pluginButton = document.getElementById('snapButton_beetleblocks-' + userid + '-' + attempt),
        pluginPlay = document.getElementById('play_beetleblocks-' + userid + '-' + attempt),
        newOnClick = "require(['assignsubmission_beetleblocks/view'], function(View) {View.toogleFullScreen('" +
            userid + "', '" +
...
const enterFS = (userid, attempt) => {
    var cont = document.getElementById('snapContainer_beetleblocks-' + userid + '-' + attempt),
        toggler = document.getElementById('togglingFSicon_beetleblocks-' + userid + '-' + attempt),
        iframe = document.getElementById('snap_beetleblocks-' + userid + '-' + attempt),
        navBar = document.getElementById('snapNavBar_beetleblocks-' + userid + '-' + attempt);
...
const exitFS = (userid, attempt) => {
    var toggler = document.getElementById('togglingFSicon_beetleblocks-' + userid + '-' + attempt),
        iframe = document.getElementById('snap_beetleblocks-' + userid + '-' + attempt),
        navBar = document.getElementById('snapNavBar_beetleblocks-' + userid + '-' + attempt);
