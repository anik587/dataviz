 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_beetleblocks_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_beetleblocks');
    ...
    /**
     * Processes one assignsubmission_beetleblocks element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_beetleblocks_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignsubmission_snap_bb', $data);

        $this->add_related_files('assignsubmission_beetleblocks', 'submission_beetleblocks', 'submission', null, $oldsubmissionid);
    }
