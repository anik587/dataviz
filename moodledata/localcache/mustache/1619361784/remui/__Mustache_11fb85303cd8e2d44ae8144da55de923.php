...
class __Mustache_11fb85303cd8e2d44ae8144da55de923 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('theme_remui/remui_popover_region')) {
            $context->pushBlockContext(array(
                'classes' => array($this, 'block560f20fa301c47a8999e68fa87cc341a'),
                ...
                'headeractions' => array($this, 'block0f9fc5b391bd631387826e6e72672cf1'),
...
';
    ...
    public function block560f20fa301c47a8999e68fa87cc341a($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . 'popover-region-notifications nav-item m-0';
...
';
    ...
    public function block0f9fc5b391bd631387826e6e72672cf1($context)
    {
        $indent = $buffer = '';
...
';
        $buffer .= $indent . '            <span class="normal-icon" aria-label="';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->sectionD52891bef9837f9da27028964220b7a5($context, $indent, $value);
        $buffer .= '">';
