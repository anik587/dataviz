...
class __Mustache_4c0db646ffefb032d84c067ddd8dab24 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <i class="icon fa fa-plus" aria-hidden="true"></i>
';
        $buffer .= $indent . '        ';
        // 'str' section
...
';
        $buffer .= $indent . '            <div class="input-search input-search-dark">
';
...
';
        $buffer .= $indent . '                <i class="input-search-icon fa fa-search" aria-hidden="true"></i>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
