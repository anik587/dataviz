...
class __Mustache_66a5b0b6834c6e7bc80dadf70a0dd1ce extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="popover-region-header-container p-3 h-auto">
';
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section04050ce7431032fae75cac4528ede4c4($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
    ...
    private function section04050ce7431032fae75cac4528ede4c4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <a class="see-all-link"
                    href="{{{.}}}">
                    <div class="popover-region-footer-container p-2 justify-content-center h-auto">
...
';
                ...
                $buffer .= '">
';
                $buffer .= $indent . '                    <div class="popover-region-footer-container p-2 justify-content-center h-auto">
';
