...
class __Mustache_84645ac0f039716124756f7ec0fee9d9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="px-2 py-3" aria-hidden="false" ';
...
';
        $buffer .= $indent . '                <span class="input-group-text p-2 bg-white border-0">
';
        $buffer .= $indent . '                    ';
        // 'pix' section
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '            <span class="badge bg-primary text-white rounded-circle ml-2 ';
