...
class __Mustache_b8f82ae4208bcecdfffb34b4cd89f5ee extends Mustache_Template
{
...
';
        $buffer .= $indent . '<div
';
        $buffer .= $indent . '    class="section border-0 bg-transparent card px-2"
';
...
';
        $buffer .= $indent . '            class="btn btn-link w-100 text-left p-2 d-flex align-items-center overview-section-toggle bg-transparent ';
