...
class __Mustache_f4380f339d11ac8baea696f50b956efc extends Mustache_Template
{
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="hidden list-group p-1" data-region="content-container">
';
        $buffer .= $indent . '        ';
